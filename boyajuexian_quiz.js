const quizQuestions = [
    {
        ...
        options: [
            ...
            { textStructure: [{w: "动词", p: "dòng cí"}, "，", {w: "拍打", p: "pāi dǎ"}], en: "A verb, meaning to slap or beat.", correct: false, explanationStructure: [{w: "错误", p: "cuò wù"}, "，", {w: "古琴", p: "gǔ qín"}, {w: "是用手弹", p: "shì yòng shǒu tán"}, "，", {w: "不是用手拍", p: "bú shì yòng shǒu pāi"}, "。"], explanationEn: "Incorrect. You pluck the strings of a zither; you do not slap or beat it like a drum." },
    ...
    },
    {
        ...
        options: [
            { textStructure: [{w: "得到", p: "dé dào"}, "、", {w: "捡到", p: "jiǎn dào"}, {w: "东西", p: "dōng xi"}], en: "To obtain or pick up a physical object.", correct: false, explanationStructure: [{w: "错误", p: "cuò wù"}, "，", {w: "这里", p: "zhè lǐ"}, {w: "不是指", p: "bú shì zhǐ"}, {w: "拿到", p: "ná dào"}, {w: "具体的物品", p: "jù tǐ de wù pǐn"}, "。"], explanationEn: "Incorrect. This does not mean receiving a physical object or money." },
            { textStructure: [{w: "领会", p: "lǐng huì"}, "、", {w: "理解", p: "lǐ djiě"}, "、", {w: "明白", p: "míng bai"}], en: "To understand, comprehend, or capture the inner meaning.", correct: true, explanationStructure: [{w: "正确", p: "zhèng què"}, "，", {w: "指钟子期", p: "zhǐ zhōng zǐ qī"}, {w: "总能听懂", p: "zǒng néng tīng dǒng"}, {w: "伯牙的心意", p: "bó yá de xīn yì"}, "。"], explanationEn: "Correct. Here, 'dé' means to fully understand or capture the emotion behind Boya's music." },
    ...
    {
        id: 5,
        textStructure: [{w: "成语", p: "chéng yǔ"}, "“", {w: "知音", p: "zhī yīn"}, "”", {w: "在现代生活", p: "zài xiàn dài shēng huó"}, {w: "中，", "主要"}, {w: "用来比喻", p: "yòng lái bǐ yù"}, "？"],
        en: "What does the idiom 'Zhiyin' describe in modern daily life?",
        options: [
            { textStructure: [{w: "听力", p: "tīng lì"}, {w: "特别好的", p: "tè bié hǎo de"}, {w: "耳科医生", p: "ěr kē yī shēng"}], en: "A doctor who has excellent hearing skills.", correct: false, explanationStructure: [{w: "胡说", p: "hú shuō"}, "，", {w: "完全不是", p: "wán quán bú shì"}, {w: "医学词汇", p: "yī xué cí huì"}, "。"], explanationEn: "Incorrect. This is not a medical term for hearing or ear health." },
